...
While Artmuseum is a great WordPress theme it might not be for everyone therefore you might want to check other free <a href="https://colorlib.com/wp/themes/" target="_blank">WordPress themes</a> that are created by Colorlib.
...
1. Upload the whole contents of the folder `artmuseum-companion` to the `/wp-content/plugins/` directory
...
Currently it works only with Artmuseum theme.

= Am I obligated to use it? =

You can still use Artmuseum theme without this plugin but you won't be able to import demo content and use theme specific widgets that you see on front page of theme demo.
