...
// image default alt
if( ! function_exists( 'artmuseum_img_default_alt' ) ) {
	function artmuseum_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'artmuseum_img_tag' ) ) {
	function artmuseum_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = artmuseum_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'artmuseum_anchor_tag' ) ) {
	function artmuseum_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'art-museum' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'artmuseum_heading_tag' ) ) {
	function artmuseum_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'art-museum' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'artmuseum_paragraph_tag' ) ) {
	function artmuseum_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'artmuseum_other_tag' ) ) {
	function artmuseum_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'artmuseum_button_element ' ) ) {
	function artmuseum_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'art-museum' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
