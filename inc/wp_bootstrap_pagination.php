...
function artmuseum_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'art-museum' ),
        'next_string'     => esc_html__( '&raquo;', 'art-museum' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'artmuseum_pagination_defaults', $defaults )
    );
