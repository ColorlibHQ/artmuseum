...
class ArtMuseum_Enqueue {

	public $scripts = array();

	public function artmuseum_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'artmuseum_frontend_enqueue_scripts', ) );
	}

	public function artmuseum_frontend_enqueue_scripts( ) {
